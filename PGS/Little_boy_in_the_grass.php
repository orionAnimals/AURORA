...
<!-- head php -->
<head>
    <title>Little boy in the grass (audio) | AURORA</title>
    <?php
        include 'head.php';
    ?>
</head>
        ...
        <main>
           <div class="wrapper_for_Information_pre_video">
            <!-- Name of the current song -->
               <span class="name_of_the_song">AURORA - Little boy in the grass</span>
            <!-- likes and dislikes -->
           ...
           <div class="video_main videoplayer">
               <video class="video" src="/video/Little_boy_in_the_grass.mp4" poster="" autoplay="false" preload="metadata"></video><!-- #t=0.5 -->
