...
<!-- head php -->
<head>
    <title>Murder Song (5, 4, 3, 2, 1) watch online  | AURORA</title>
    <?php
        include 'head.php';
    ?>
</head>
        ...
        <main>
           <div class="wrapper_for_Information_pre_video">
            <!-- Name of the current song -->
               <span class="name_of_the_song">AURORA - Murder Song (5, 4, 3, 2, 1)</span>
            <!-- likes and dislikes -->
           ...
           <div class="video_main videoplayer">
               <video class="video" src="/video/Murder_song.mp4" poster="" autoplay="false" preload="metadata"></video><!-- #t=0.5 -->
