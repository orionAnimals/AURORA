...
<!-- head php -->
<head>
    <title>The river watch online</title>
    <?php
        include 'head.php';
    ?>
</head>
        ...
        <main>
           <div class="wrapper_for_Information_pre_video">
            <!-- Name of the current song -->
               <span class="name_of_the_song">AURORA - The river</span>
            <!-- likes and dislikes -->
               <div class="wrapper_for_likes_dislikes">
                   <button class="likes"><i class="fa-solid fa-heart"></i> 255K</button>
                   <button class="dislikes"><i class="fa-solid fa-heart-crack"></i> 9</button>
               </div>
            <!-- More btn ... -->
           ...
           <div class="video_main videoplayer">
               <video class="video" src="/video/The_river.mp4" poster="" preload="metadata"></video><!-- #t=0.5 -->
               <!-- Video player main wrapp -->
               <div class="wrapper_player_vid">
                  <!-- Name, date.... -->
                  <div class="wrapp_name_date_etc">
                     <span class="date_vid"><i class="fa-solid fa-clock"></i> 22.03.2019</span>
                     <span class="vievs_vid"><i class="fa-solid fa-eye"></i> 12M</span>
                  </div>
                  ...
                  <div class="wrapp_timeline_main_vid">
                     ...
                     <div class="wrapp_timeline_vid">
                        <input type="range" class="timeline_vid" max="100" step="0.001" value="0">
