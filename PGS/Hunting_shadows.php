...
<!-- head php -->
<head>
    <title>Hunting Shadows (Assassin’s Creed) watch online  | AURORA</title>
    <?php
        include 'head.php';
    ?>
</head>
        ...
        <main>
           <div class="wrapper_for_Information_pre_video">
            <!-- Name of the current song -->
               <span class="name_of_the_song">AURORA - Hunting Shadows (Assassin’s Creed)</span>
            <!-- likes and dislikes -->
           ...
           <div class="video_main videoplayer">
               <video class="video" src="/video/Hunting_shadows.mp4" poster="" autoplay="false" preload="metadata"></video><!-- #t=0.5 -->
               ...
               <div class="wrapper_player_vid">
                  ...
                  <div class="wrp_right_btns_controls_vid">
                     <!-- settings -->
                     <div class="wrapp_settings_video">
                        something...
                     </div>
