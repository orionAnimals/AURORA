...
<!-- head php -->
<head>
    <title>Through The Eyes Of A Child (Live) - Stripped (Vevo) | AURORA</title>
    <?php
        include 'head.php';
    ?>
</head>
        ...
        <main>
           <div class="wrapper_for_Information_pre_video">
            <!-- Name of the current song -->
               <span class="name_of_the_song">AURORA - Through The Eyes Of A Child (live vevo)</span>
            <!-- likes and dislikes -->
           ...
           <div class="video_main videoplayer">
               <video class="video" src="/video/Through_the_eyes_of_a_child.mp4" poster="" autoplay="false" preload="metadata"></video><!-- #t=0.5 -->
