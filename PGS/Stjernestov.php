...
<!-- head php -->
<head>
    <title>Stjernestov watch online</title>
    <?php
        include 'head.php';
    ?>
</head>
        ...
        <main>
           <div class="wrapper_for_Information_pre_video">
            <!-- Name of the current song -->
               <span class="name_of_the_song">AURORA - Stjernestov</span>
            <!-- likes and dislikes -->
           ...
           <div class="video_main videoplayer">
               <video class="video" src="/video/Stjernestov.mp4" poster="/video/Stjernestov.mp4#autoplay=false" preload="metadata"></video><!-- #t=0.5 -->
